...
USER <- Sys.info()[['user']]
USER<-"insider"
source("~/CloudComputing/10_Secrets/Azure_Authentication_datascience_AWS.R")
```
...
```{r message=FALSE, packages, eval=TRUE}
...
```{r, create resource group, eval=TRUE}
...
```{r}
source("~/CloudComputing/10_Secrets/telegram_botDJR.R")
text<-(paste(a,"Resource Group",RG,"shut down"))
